                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <button class="btn btn-info btn-sm" style="float: right" data-toggle="modal" data-target="#modal-default">Add Photo</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                @foreach ($photo as $key=>$row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('photo.destroy',$row->id) }}" id="delete" class="btn btn-danger sm delete" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
