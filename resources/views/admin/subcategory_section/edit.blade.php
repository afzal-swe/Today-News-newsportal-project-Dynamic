                                    ...
                                    <form action="{{ route('subcategory.update',$edit->id) }}" method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="subcategory_bn" class="form-control" value="{{ $edit->subcategory_bn }}">
                                            </div>
                    
                                            <div class="form-group">
                                                <label for="">Subcategory Name English</label>
                                                <input type="text" name="subcategory_en" class="form-control"  value="{{ $edit->subcategory_en }}">
                                            </div>
